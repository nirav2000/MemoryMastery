(function(){
  ...
  banner.innerHTML = '<strong>Archived Memory Mastery build 9e7045c</strong> · This may not match the current learner flow. '+(latest?'Using latest compatible data files.':'Using bundled historical data.')+' <a href="../../index.html">Version switcher</a> · <a href="?useLatestData=1">Try latest data</a> · <a href="../../../">Current app</a>';
